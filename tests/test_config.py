...
def test_settings_model_paths_are_derived_from_persistence_root():
    ...
    assert settings.mpc001_english_config_path == Path(
        "/workspace/persistence/silent-vision/repos/Visual_Speech_Recognition_for_Multiple_Languages/configs/LRS3_V_WER19.1.ini"
    )
    assert settings.mpc001_chinese_config_path == Path(
        "/workspace/persistence/silent-vision/repos/Visual_Speech_Recognition_for_Multiple_Languages/configs/CMLR_V_WER8.0.ini"
    )
